...
foreach hw_platform $hw_platforms {
    ...
    set_property -dict [list CONFIG.PSU__GPIO_EMIO__PERIPHERAL__ENABLE {1} CONFIG.PSU__GPIO_EMIO__PERIPHERAL__IO {20} CONFIG.PSU__I2C0__PERIPHERAL__IO {EMIO} CONFIG.PSU__SPI0__PERIPHERAL__ENABLE {1} CONFIG.PSU__SPI0__PERIPHERAL__IO {EMIO} CONFIG.PSU__SPI0__GRP_SS1__ENABLE {1} CONFIG.PSU__SPI0__GRP_SS2__ENABLE {1} CONFIG.PSU__SPI1__PERIPHERAL__ENABLE {1} CONFIG.PSU__SPI1__PERIPHERAL__IO {EMIO}] [get_bd_cells zynq_ultra_ps_e_0]
    set_property -dict [list CONFIG.PSU__SPI0__GRP_SS1__ENABLE {0} CONFIG.PSU__SPI0__GRP_SS2__ENABLE {0}] [get_bd_cells zynq_ultra_ps_e_0]
    make_bd_intf_pins_external  [get_bd_intf_pins zynq_ultra_ps_e_0/SPI_1]
    make_bd_intf_pins_external  [get_bd_intf_pins zynq_ultra_ps_e_0/SPI_0]
    ...
    set_property name nuprism_gpio [get_bd_intf_ports GPIO_0_0]
    set_property name ps_master_i2c [get_bd_intf_ports zynq_i2c]
    set_property name ps_spi_0 [get_bd_intf_ports SPI_0_0]
    set_property name ps_ctrl_gpio [get_bd_intf_ports ctrl_gpio]
    set_property name ps_spi_1 [get_bd_intf_ports SPI_1_0]
